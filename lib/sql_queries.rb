...
# projects (id INTEGER PRIMARY KEY, title TEXT, category TEXT, funding_goal INTEGER, start_date NUMERIC, end_date NUMERIC);

# users (id INTEGER PRIMARY KEY, name TEXT, age INTEGER);

# pledges (id INTEGER PRIMARY KEY, amount NUMBERIC, 
